...
/**
 * @brief Resamples audio data to a target sampling rate.
 *
 * This function takes audio data as a vector of float values, the original
 * sampling rate, and the target sampling rate, and resamples the audio
 * data to the target sampling rate using the libsamplerate library.
 *
 * @param audioData A vector of float values representing the input audio data.
 * @param originalSampleRate The original sampling rate of the audio data.
 * @param targetSampleRate The target sampling rate to resample the audio data to.
 * @return A vector of float values representing the resampled audio data.
 * @throws std::runtime_error if an error occurs during the resampling process.
 */
